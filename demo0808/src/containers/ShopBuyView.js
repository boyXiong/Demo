      ...
      <div className="block content">
        ...
        <ul className="content-price-wrap clear">
          <div className="buy-package">
            <div className="buy-package-item"><span className="buy-coin-text">100天</span></div>
            <div className="buy-package-item"><span className="buy-new-coin-unit">￥</span><span className="buy-new-coin-text">88</span></div>
            <div className="buy-package-item"><span className="buy-save-coin">省32元</span></div>
          </div>
          <div className="buy-package">
            <div className="buy-package-item"><span className="buy-coin-text">30天</span></div>
            <div className="buy-package-item"><span className="buy-new-coin-unit">￥</span><span className="buy-new-coin-text">88</span></div>
            <div className="buy-package-item"><span className="buy-save-coin">省32元</span></div>
          </div>
          <div className="buy-package">
            <div className="buy-package-item"><span className="buy-coin-text">365天</span></div>
            <div className="buy-package-item"><span className="buy-new-coin-unit">￥</span><span className="buy-new-coin-text">88</span></div>
            <div className="buy-package-item"><span className="buy-save-coin">省32元</span></div>
          </div>
        </ul>
